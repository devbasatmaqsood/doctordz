...
const AdminSetting = () => {
  ...
  const [zegoServerSecret, setZegoServerSecret] = useState<any>();
  ...
  useEffect(() => {
    ...
    setZegoServerSecret(setting?.zegoServerSecret);
  }, [setting]);
  ...
  const handleSubmit = (e: any) => {
    ...
    if (
    ...
    ) {
      {
        ...
        if (!zegoServerSecret) error.zegoServerSecret = "Zego Server Secret is Required";
            ...
            <div className="settingBoxOuter">
              ...
              <div className="col-12 ">
                <ExInput
                  ...
                  placeholder={`ZegoServer Secret`}
                  errorMessage={error.zegoServerSecret && error.zegoServerSecret}
                  ...
                  onChange={(e: any) => {
                    ...
                    if (!e.target.value) {
                      return setError({
                        ...error,
                        zegoServerSecret: `ZegoServer Is Required`,
                      });
                    } else {
                      return setError({
                        ...error,
